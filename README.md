...
<br/>
С целью быстрой и наглядной демонстрации навыков, полученных в ходе прохожения курса "Аналитик данных" в Яндекс.Практикуме, была составлена таблица с пройденными проектами. Список проектов был составлен по мере их выполненияㅤ
<br/><br/>
<table>
<tr>
